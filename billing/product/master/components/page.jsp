...
$(function () {
    ...
    function makeProductAutocomplete(inputId, hiddenId) {
        ...
        $input.autocomplete({
            ...
            minLength: 2,
            // Prevent down-arrow from putting the ID into the text box
        ...
        // Auto-select first item on Tab or Enter when dropdown is open
            ...
            if ((e.keyCode === 9 || e.keyCode === 13) &&
                ...
                if (first.length) {
                    ...
                    if (item) {
                        ...
                        $input.removeClass("is-invalid");
                        if (e.keyCode === 9) return; // allow Tab to move focus
                        e.preventDefault();
                    }
                }
            }
        ...
        // Clear hidden ID when user edits text
