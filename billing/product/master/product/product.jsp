...
<% } %>
                ...
                <div class="card" style="border: none; box-shadow: 0 2px 4px rgba(0,0,0,.07); border-radius: 8px;">
                    ...
                    <div class="card-body" style="padding: 1rem;">
                        <form id="productForm" action="<%=contextPath%>/product/master/product/product1.jsp" method="post" class="row g-2">
                            ...
                            <div class="col-md-6 ">
                                <label id="costPriceLabel" style="font-size: 0.85rem;">Cost Price <span style="color:red">*</span></label><input type="number" step="0.001" name="cost" id="costInput" class="form-control" placeholder=" " style="padding: 7px 10px; font-size: 0.9rem;" onwheel="this.blur()" required>
                                <small id="costConversionNote" class="text-muted d-block mt-1"></small>
                            </div>
                            <div class="col-md-6 ">
                                <label id="mrpLabel" style="font-size: 0.85rem;">MRP <span style="color:red">*</span></label><input type="number" step="0.001" name="mrp" id="mrpInput" class="form-control" placeholder=" " style="padding: 7px 10px; font-size: 0.9rem;" onwheel="this.blur()" required>
                                <small id="mrpConversionNote" class="text-muted d-block mt-1"></small>
                            </div>
                            <div class="col-md-6 ">
                                <label style="font-size: 0.85rem;"><%=head3%> Code <span style="color:red">*</span></label><input type="text" name="productCode" class="form-control" placeholder="" value="0" style="padding: 7px 10px; font-size: 0.9rem;" >
                            </div>
                            <input type="hidden" name="hsn" value="0">
    ...
    function populateForm(product) {
        ...
        form.querySelector('[name="productCode"]').value = product.prodCode || '0';
