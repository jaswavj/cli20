...
<div class="bw">
    ...
    <div class="top-panel">
        ...
        <div class="tp-row">
            ...
            <button class="bb bb-outline" onclick="showOrderList()">
                <i class="fa-solid fa-mug-hot"></i> CAFE ORDER
            </button>
            <a href="<%=contextPaths%>/cafeOrder/order/page.jsp" class="bb bb-outline">
                <i class="fa-solid fa-utensils"></i> ORDER
            </a>
        </div>
